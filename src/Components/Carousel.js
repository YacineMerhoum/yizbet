...
import { fetchMatchDetails, fetchMatchPortugal } from '../slices/matchSlice';
...
function DarkVariantExample() {
  ...
  useEffect(() => {
    ...
    dispatch(fetchMatchPortugal()); // Appelle la fonction pour récupérer les détails du match du Portugal
  }, [dispatch]);
    ...
    <Carousel data-bs-theme="dark">
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <h2>{traduction[matchDetails.homeTeam.name]} <span className='me-2'>vs</span>
          {traduction[matchDetails.awayTeam.name]}</h2>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <div className='carouselBg'>
            <img className='flagMenu' src={matchDetailsPortugal.homeTeam.crest} />
            <img className='flagMenu' src={matchDetailsPortugal.awayTeam.crest} />

            <h2>{traduction[matchDetailsPortugal.homeTeam.name]} <span className='me-2'>vs</span>
            {traduction[matchDetailsPortugal.awayTeam.name]}</h2>
            <img className='LogoCompet' src={LogoEuro24} />
            <p>{matchDetailsPortugal.venue}</p>
            <p><em>{formattedDatePortugal}</em></p> 
            <Button variant="light" className='m-1'>Light</Button>
            <Button variant="light" className='m-1'>Light</Button>
            <Button variant="light" className='m-1'>Light</Button>
          </div>
